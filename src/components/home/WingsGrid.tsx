        ...
        <ul className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {wings.map((wing) => (
            <li key={wing.id}>
              <Link
                href={wing.href}
                className="group border-emberlight-blue/10 hover:border-antique-gold/50 relative flex h-full flex-col rounded-2xl border bg-white/60 p-6 transition-all hover:-translate-y-0.5 hover:shadow-sm"
              >
                ...
                <span className="text-ledger-gray/60 group-hover:text-antique-gold mt-6 text-[10px] tracking-[0.25em] uppercase transition-colors">
                  Enter →
                </span>
              </Link>
            </li>
